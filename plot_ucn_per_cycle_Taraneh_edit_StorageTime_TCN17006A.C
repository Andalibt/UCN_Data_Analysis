...
void plot_ucn_per_cycle_Taraneh_edit_StorageTime_TCN17006A(){  
  // Get the file
  char *filename[200];
  ...
  TFile hfile ("outputTree_StorageTime_17006A.root", "RECREATE");
 ...
 TH2F *psd_vs_ql_withcuts[16];
  ...
  Int_t StorageTimeFiles[173] = {605, 606, 607, 608, 609, 610,611, 612, 613};
