...
void StorageTime_17014_Taraneh_edit_ver1(){
  gStyle->SetOptFit(1111);
  // READ THE TREE
  
  TFile *fin = new TFile("outputTree_StorageTime_17014.root","READ");
  if ( fin->IsOpen() ){
  ...
  TH2* StorageTime = new TH2F("StorageTime", "Counts vs Delay Time", 1000, 0., 190. , 1000,  0., 50000);
  
  // HISTOGRAM TO SHOW THE TOTAL UCN (ONLY) COUNTS VS THE ISOPURE TEMPERATURE
  TH2* StorageTemp = new TH2F("StorageTemp", "Counts vs Temperture", 1000, 0.83, 1.5,  1000,  0., 50000);
  ...
  TH2* IrradTemp = new TH2F("UCN", "Irradiation Time vs Temperature", 1000, 0, 200 , 1000, 0.83, 1.5);
  
  // HISTOGRAM TO SHOW THE AVERAGE ISOPURE TEMPERATURE VS BEAM CURRENT
  TH2* TempBeam = new TH2F("UCN", "Temperature vs Beam Current", 1000, 0.83, 1.5 , 1000, 0, 130);
  
  // HISTOGRAM TO SHOW THE THE TOTAL UCN (ONLY) COUNTS VS AVERAGE BEAM CURRENT
  TH2* UCNBeam = new TH2F("UCN", "UCN Counts vs Beam Current" , 1000, 0, 130 , 1000 , 0 , 50000 );
  
  // HISTOGRAM TO SHOW THE TOTAL UCN (ONLY) COUNT VS IRRADIATION TIME
  TH2* UCNIrrad = new TH2F("UCN", "UCN Counts vs Irradiation Time" , 1000, 0, 200 , 1000 , 0 , 50000 );
  ...
  text -> SetTextAngle(0);
  text -> DrawText(0.4, 0.8, "Exp #: TCN17014");
