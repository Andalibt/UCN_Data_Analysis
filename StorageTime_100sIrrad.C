...
void StorageTime_100sIrrad(){
  gStyle->SetOptFit(0000);

  // OPENING ALL THE FILES
  TFile *fin1 = new TFile("outputTree_StorageTime_17004B.root","READ");
  ...
  // INTEGRAL
  double storagehist004B_1expfit = 0;
  ...
  outputTree1 -> SetBranchAddress ("AVE_TS12_VALVEOPEN" , &avets12ValveOpen_004B);
 ...
 TCanvas *c1 = new TCanvas("c1", "c1",900,500);
  ...
  double experiment[10] = {17004B};
  
  // STORAGE TIME FROM THE ONE EXPONENTIAL FIT FUNCTION
  double storagefit_1expfit[10] = { storagefit004B_1expfit};
  
  // ERROR ASSOCIATED WITH THE STORAGE TIME FROM ONE FIT FUNCTION
  double storageErrfit_1expfit[10] = {storageErrfit004B_1expfit};
