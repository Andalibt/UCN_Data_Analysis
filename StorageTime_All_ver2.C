...
// AVERAGE ISOPURE TEMPERATURE DURING VALVE OPEN
 ...
 // STANDARD DEVIATION FROM THE AVERAGE OF AVERAGES OF TEMPERATURE
  ...
  for (ULong64_t j = 0 ; j < event1 ; j++){
    ...
    aveT003+=avets12ValveOpen_003;
    counts1++;
  }
  aveT003 = aveT003/counts1;

  for (ULong64_t j = 0 ; j < event1 ; j++){
    outputTree003-> GetEvent(j);
    if ( HistIntegral1 < 2000)
      continue;
    sdT003 += (avets12ValveOpen_003 - aveT003)* (avets12ValveOpen_003 - aveT003);
  }
  sdT003 = sqrt (sdT003/counts1);
    cout << aveT003 << "    " << sdT003 << endl;
  ...
  for (ULong64_t j = 0 ; j < event2 ; j++){
    ...
    aveT013+=avets12ValveOpen_013;
    counts2++;
  }
  aveT013 = aveT013/counts2;

  for (ULong64_t j = 0 ; j < event2 ; j++){
    outputTree013-> GetEvent(j);
    sdT013 += (avets12ValveOpen_013 - aveT013)* (avets12ValveOpen_013 - aveT013);
  }
  sdT013 = sqrt (sdT013/counts2);
  //  cout << aveT013 << "    " << sdT013 << endl;
  ...
  for (ULong64_t j = 0 ; j < event3 ; j++){
    ...
    aveT023+=avets12ValveOpen_023;
    counts3++;
  }
  aveT023 = aveT023/counts3;
  for (ULong64_t j = 0 ; j < event3 ; j++){
    outputTree023 -> GetEvent(j);
    sdT023 += (avets12ValveOpen_023 - aveT023)* (avets12ValveOpen_023 - aveT023);
  }
  sdT023 = sqrt (sdT023/counts3);
  //   cout << aveT023 << "    " << sdT023 << endl;
  ...
  for (ULong64_t j = 0 ; j < event4 ; j++){
    ...
    aveT025+=avets12ValveOpen_025;
    counts4++;
  }
  aveT025 = aveT025/counts4;

  for (ULong64_t j = 0 ; j < event4 ; j++){
    outputTree025 -> GetEvent(j);
    sdT025 += (avets12ValveOpen_025 - aveT025)* (avets12ValveOpen_025 - aveT025);
  }
  sdT025 = sqrt (sdT025/counts4);
    cout << aveT025 << "    " << sdT025 << endl;
  ...
  for (ULong64_t j = 0 ; j < event5 ; j++){
    ...
    if (j <event5-1)
      aveT026 +=avets12ValveOpen_026;
    counts5++;
  }
  aveT026 = aveT026/(counts5-1);

  for (ULong64_t j = 0 ; j < event5-1 ; j++){
    outputTree026 -> GetEvent(j);
    sdT026 += (avets12ValveOpen_026 - aveT026)* (avets12ValveOpen_026 - aveT026);
    //    cout << sdT026 << endl;
  }

  sdT026 = sqrt (sdT026/(counts5-1));
  cout << aveT026 << "    " << sdT026 << endl;
  ...
  for (ULong64_t j = 0 ; j < event6 ; j++){
    ...
    aveT029A+=avets12ValveOpen_029A;
    counts6++;
  }
  aveT029A = aveT029A/counts6;

  for (ULong64_t j = 0 ; j < event6 ; j++){
    outputTree029A -> GetEvent(j);
    sdT029A += (avets12ValveOpen_029A - aveT029A)* (avets12ValveOpen_029A - aveT029A);
  }
  sdT029A = sqrt (sdT029A/counts6);
  //    cout << aveT029A << "    " << sdT029A << endl;
  ...
  for (ULong64_t j = 0 ; j < event7 ; j++){
    ...
    aveT031+=avets12ValveOpen_031;
    counts7++;
  }
  aveT031 = aveT031/counts7;

  for (ULong64_t j = 0 ; j < event7 ; j++){
    outputTree031 -> GetEvent(j);
    sdT031 += (avets12ValveOpen_031 - aveT031)* (avets12ValveOpen_031 - aveT031);
  }
  sdT031 = sqrt (sdT031/counts7);
  cout << aveT031 << "    " << sdT031 << endl;
  ...
  for (ULong64_t j = 0 ; j < event8 ; j++){
    ...
    aveT002+=avets12ValveOpen_002;
    counts8++;
  }
  aveT002 = aveT002/counts8;

  for (ULong64_t j = 0 ; j < event8 ; j++){
    outputTree002 -> GetEvent(j);
    sdT002 += (avets12ValveOpen_002 - aveT002)* (avets12ValveOpen_002 - aveT002);
  }
  sdT002 = sqrt (sdT002/counts8);
  cout << aveT002 << "    " << sdT002 << endl;
  ...
  for (ULong64_t j = 0 ; j < event9 ; j++){
    ...
    aveT006+=avets12ValveOpen_006;
    counts9++;
  }
  aveT006 = aveT006/counts9;
  ...
  for (ULong64_t j = 0 ; j < event9 ; j++){
    ...
    if (UCNIntegral9 < 100)
      continue;
    sdT006 += (avets12ValveOpen_006 - aveT006)* (avets12ValveOpen_006 - aveT006);
  }
  sdT006 = sqrt (sdT006/counts9);
  cout << aveT006 << "    " << sdT006 << endl;
  ...
  for (ULong64_t j = 0 ; j < event10 ; j++){
    ...
    aveT021+=avets12ValveOpen_021;
    counts10++;
  }
  aveT021 = aveT021/counts10;

  for (ULong64_t j = 0 ; j < event10 ; j++){
    outputTree021 -> GetEvent(j);
    sdT021 += (avets12ValveOpen_021 - aveT021)* (avets12ValveOpen_021 - aveT021);
  }
  sdT021 = sqrt (sdT021/counts10);
  cout << aveT021 << "    " << sdT021 << endl;
  ...
  for (ULong64_t j = 0 ; j < event12 ; j++){
    ...
    aveT004B+=avets12ValveOpen_004B;
    counts12++;
  }
  aveT004B = aveT004B/counts12;

  for (ULong64_t j = 0 ; j < event12; j++){
    outputTree004B -> GetEvent(j);
    sdT004B += (avets12ValveOpen_004B - aveT004B)* (avets12ValveOpen_004B - aveT004B);
  }
  sdT004B = sqrt (sdT004B/counts12);
  cout << aveT004B << "    " << sdT004B << endl;
  ...
  for (ULong64_t j = 0 ; j < event13 ; j++){
    ...
    if (irradTimeArray13[j] > 9. && irradTimeArray13[j]< 11.  ){
      ...
      aveT009_10+= avets12ValveOpen_009;
      counts13_10++;
      //cout << UCNIntegralArray13_10[j] << " " <<UCNIntegralErrArray13_10[j] << " " << delayTimeArray13_10[j] << " " << counts13_10 << " " << HistIntegralArray13_10[j] <<endl;
    }
     // for 30s irradiation time
    if (irradTimeArray13[j] > 29.  && irradTimeArray13[j]< 31){
      ...
      aveT009_30+= avets12ValveOpen_009;
      counts13_30++;
    }
    // for 60s irradiation time
    if (irradTimeArray13[j] > 59. && irradTimeArray13[j] < 61. ){
      ...
      aveT009_60+= avets12ValveOpen_009;
      counts13_60++;
    }
  ...
  aveT009_10 = aveT009_10/counts13_10;
  aveT009_30 = aveT009_30/counts13_30;
  aveT009_60 = aveT009_60/counts13_60;

  for (ULong64_t j = 0 ; j < event13 ; j++){
    outputTree009 -> GetEvent(j);
    // for 10s irradiation time
    if (irradTimeArray13[j] > 9. && irradTimeArray13[j]< 11.  ){
      sdT009_10 += (avets12ValveOpen_009 - aveT009_10)* (avets12ValveOpen_009 - aveT009_10);
    }

     // for 30s irradiation time
    if (irradTimeArray13[j] > 29.  && irradTimeArray13[j]< 31){
      sdT009_30 += (avets12ValveOpen_009 - aveT009_30)* (avets12ValveOpen_009 - aveT009_30);
    }
    
    // for 60s irradiation time
    if (irradTimeArray13[j] > 59. && irradTimeArray13[j] < 61. ){
      sdT009_60 += (avets12ValveOpen_009 - aveT009_60)* (avets12ValveOpen_009 - aveT009_60);
    }

  }

  sdT009_10 = sqrt (sdT009_10/counts13_10);
  sdT009_30 = sqrt (sdT009_30/counts13_30);
  sdT009_60 = sqrt (sdT009_60/counts13_60);
  cout << aveT009_10 << "    " << sdT009_10 << endl;
  cout << aveT009_30 << "    " << sdT009_30 << endl;
  cout << aveT009_60 << "    " << sdT009_60 << endl;
  ...
  for (ULong64_t j = 0 ; j < event14 ; j++){
    ...
    if (irradTimeArray14[j] > 9. && irradTimeArray14[j]<11.  ){
      ...
      aveT009A_10+= avets12ValveOpen_009A;
      counts14_10++;
    }
    // for 30s irradiation time
    if (irradTimeArray14[j]>  29. && irradTimeArray14[j] < 31. ){
      ...
      aveT009A_30+= avets12ValveOpen_009A;
      counts14_30++;
    }
    ...
    if (irradTimeArray14[j] > 59. && irradTimeArray14[j] < 61. ){
      ...
      //cout << UCNIntegralArray14_60[j] << " " << delayTimeArray14_60[j]<<endl;
      aveT009A_60+= avets12ValveOpen_009A;
      counts14_60++;
    }
    // for 120s irradiation time
    if (irradTimeArray14[j] >  119. && irradTimeArray14[j] <121.){
      ...
      aveT009A_120+= avets12ValveOpen_009A;
      counts14_120++;
    }    
  ...
  aveT009A_10 = aveT009A_10/counts14_10;
  aveT009A_30 = aveT009A_30/counts14_30;
  aveT009A_60 = aveT009A_60/counts14_60;
  aveT009A_120 = aveT009A_120/counts14_120;

  for (ULong64_t j = 0 ; j < event14 ; j++){
    outputTree009A -> GetEvent(j);
    // for 10s irradiation time
    if (irradTimeArray14[j] > 9. && irradTimeArray14[j]< 11.  ){
      sdT009A_10 += (avets12ValveOpen_009A - aveT009A_10)* (avets12ValveOpen_009A - aveT009A_10);
    }

     // for 30s irradiation time
    if (irradTimeArray14[j] > 29.  && irradTimeArray14[j]< 31){
      sdT009A_30 += (avets12ValveOpen_009A - aveT009A_30)* (avets12ValveOpen_009A - aveT009A_30);
    }
    
    // for 60s irradiation time
    if (irradTimeArray14[j] > 59. && irradTimeArray14[j] < 61. ){
      sdT009A_60 += (avets12ValveOpen_009A - aveT009A_60)* (avets12ValveOpen_009A - aveT009A_60);
    }
    // for 120s irradiation time
    if (irradTimeArray14[j] >  119. && irradTimeArray14[j] <121.){
      sdT009A_120 += (avets12ValveOpen_009A - aveT009A_120)* (avets12ValveOpen_009A - aveT009A_120);
    }
  }
  sdT009A_10 = sqrt (sdT009A_10/counts14_10);
  sdT009A_30 = sqrt (sdT009A_30/counts14_30);
  sdT009A_60 = sqrt (sdT009A_60/counts14_60);
  sdT009A_120 = sqrt (sdT009A_120/counts14_120);

  cout << aveT009A_10 << "    " << sdT009A_10 << endl;
  cout << aveT009A_30 << "    " << sdT009A_30 << endl;
  cout << aveT009A_60 << "    " << sdT009A_60 << endl;
  cout << aveT009A_120 << "    " << sdT009A_120 << endl;
  ...
  for (ULong64_t j = 0 ; j < event15 ; j++){
    ...
    aveT014+=avets12ValveOpen_014;
    counts15++;
  }
  aveT014 = aveT014/counts15;

  for (ULong64_t j = 0 ; j < event15; j++){
    outputTree014 -> GetEvent(j);
    sdT014 += (avets12ValveOpen_014 - aveT014)* (avets12ValveOpen_014 - aveT014);
  }
  sdT014 = sqrt (sdT014/counts15);
  cout << aveT014 << "    " << sdT014 << endl;
  ...
  for (ULong64_t j = 0 ; j < event16 ; j++){
    ...
    aveT029+=avets12ValveOpen_029;
    counts16++;
  }
  aveT029 = aveT029/counts16;

  for (ULong64_t j = 0 ; j < event16; j++){
    outputTree029 -> GetEvent(j);
    sdT029 += (avets12ValveOpen_029 - aveT029)* (avets12ValveOpen_029 - aveT029);
  }
  sdT029 = sqrt (sdT029/counts16);
  cout << aveT029 << "    " << sdT029 << endl;
  ...
  for (ULong64_t j = 0 ; j < event17 ; j++){
    ...
    aveT006A+=avets12ValveOpen_006A;
    counts17++;
  }
   aveT006A = aveT006A/counts17;

  for (ULong64_t j = 0 ; j < event17; j++){
    outputTree006A -> GetEvent(j);
    sdT006A += (avets12ValveOpen_006A - aveT006A)* (avets12ValveOpen_006A - aveT006A);
  }
  sdT006A = sqrt (sdT006A/counts17);
  cout << aveT006A << "    " << sdT006A << endl;
...
TGraphErrors *gr004A_150 = new TGraphErrors(counts11_150, delayTimeArray11_150, UCNIntegralArray11_150, 0 , UCNIntegralErrArray11_150);
  ...
  */
  ...
  // INTEGRAL FROM THE HISTOGRM
  TGraph *gr006A_hist = new TGraph(counts17, delayTimeArray17, HistIntegralArray17);
  ...
  double temp_10[2] = {aveT009_10, aveT009A_10};
  double tempErr_10[2]={sdT009_10, sdT009A_10};
  ...
  double temp_30[4] = {aveT009_30, aveT009A_30, aveT014, aveT029};
  double tempErr_30[4] ={sdT009_30, sdT009A_30, sdT014, sdT029};
  ...
  double temp_60[13]={aveT002, aveT003, aveT006, aveT009_60, aveT009A_60, aveT025, aveT026, aveT029A, aveT031, aveT006A};
  double tempErr_60[13]={sdT002, sdT003, sdT006, sdT009_60, sdT009A_60, sdT025, sdT026, sdT029A, sdT031, sdT006A};
  ...
  double temp_100[1] = {aveT004B};
  double tempErr_100[1] = {sdT004B};
  ...
  double temp_120[1] = {aveT009A_120};
  double tempErr_120[1] = {sdT009A_120};
  ...
  grtemp30 -> GetXaxis()-> SetTitle("Isopure Temperature (#circC)");
