...
void StorageTime_60sIrrad_separateGraphs(){
  ...
  // WITH CONSIDERING UCN COUNTS FROM THE HISTOGRAM
  // INTEGRAL
  double hist003tau1 = 0;
  double hist013tau1 = 0;
  double hist023tau1 = 0;
  double hist025tau1 = 0;
  double hist026tau1 = 0;
  double hist029Atau1 = 0;
  double hist031tau1 = 0;
  double hist002tau1 = 0;
  double hist006tau1 = 0;
  double hist021tau1 = 0;

  double hist003tau2 = 0;
  double hist013tau2 = 0;
  double hist023tau2 = 0;
  double hist025tau2 = 0;
  double hist026tau2 = 0;
  double hist029Atau2 = 0;
  double hist031tau2 = 0;
  double hist002tau2 = 0;
  double hist006tau2 = 0;
  double hist021tau2 = 0;


  // ERROR ASSOCIATED WITH THE STORAGE TIME
  // FROM THE ONE EXPONENTIAL FIT CONSIDERING
  // THE UCN COUNTS FROM THE HISTOGRAM INTEGRAL
  double hist003tau1Err = 0;
  double hist013tau1Err = 0;
  double hist023tau1Err = 0;
  double hist025tau1Err = 0;
  double hist026tau1Err = 0;
  double hist029Atau1Err = 0;
  double hist031tau1Err = 0;
  double hist002tau1Err = 0;
  double hist006tau1Err = 0;
  double hist021tau1Err = 0;

  double hist003tau2Err = 0;
  double hist013tau2Err = 0;
  double hist023tau2Err = 0;
  double hist025tau2Err = 0;
  double hist026tau2Err = 0;
  double hist029Atau2Err = 0;
  double hist031tau2Err = 0;
  double hist002tau2Err = 0;
  double hist006tau2Err = 0;
  double hist021tau2Err = 0;
...
// AVERAGE ISOPURE TEMPERATURE DURING VALVE OPEN
 ...
 // FOR TCN17003
  ...
  gr11 -> Fit(fit1exp, "0");
  fit1exp -> SetLineColor(2);
  storagehist003_1expfit =fit1exp->GetParameter(1);
  storageErrhist003_1expfit =fit2exp->GetParError(1);

  gr11 -> Fit(fit2exp, "");
  fit2exp -> SetLineColor(4);
  hist003tau1  = fit2exp -> GetParameter(1);
  hist003tau2  = fit2exp -> GetParameter(2);
  hist003tau1Err  = fit2exp -> GetParError(1);
  hist003tau2Err  = fit2exp -> GetParError(2);
  ...
  gr22 -> Fit(fit1exp,"0");
  storagehist013_1expfit =fit1exp->GetParameter(1);
  storageErrhist013_1expfit =fit2exp->GetParError(1);

  gr22 -> Fit(fit2exp, "1");
  hist013tau1  = fit2exp -> GetParameter(1);
  hist013tau2  = fit2exp -> GetParameter(2);
  hist013tau1Err  = fit2exp -> GetParError(1);
  hist013tau2Err  = fit2exp -> GetParError(2);
  ...
  gr33 -> Fit(fit1exp,"0");
  storagehist023_1expfit =fit1exp->GetParameter(1);
  storageErrhist023_1expfit =fit2exp->GetParError(1);

  gr33 -> Fit(fit2exp, "1");
  hist023tau1  = fit2exp -> GetParameter(1);
  hist023tau2  = fit2exp -> GetParameter(2);
  hist023tau1Err  = fit2exp -> GetParError(1);
  hist023tau2Err  = fit2exp -> GetParError(2);
  ...
  gr44 -> Fit(fit1exp,"0");
  storagehist025_1expfit =fit1exp->GetParameter(1);
  storageErrhist025_1expfit =fit2exp->GetParError(1);

  gr44 -> Fit(fit2exp, "1");
  hist025tau1  = fit2exp -> GetParameter(1);
  hist025tau2  = fit2exp -> GetParameter(2);
  hist025tau1Err  = fit2exp -> GetParError(1);
  hist025tau2Err  = fit2exp -> GetParError(2);
  ...
  cout << "Err for fit 026 " << fit026tau2Err << endl;
  ...
  gr55 -> Fit(fit1exp,"0");
  storagehist026_1expfit =fit1exp->GetParameter(1);
  storageErrhist026_1expfit =fit2exp->GetParError(1);

  gr55 -> Fit(fit2exp, "1");
  hist026tau1  = fit2exp -> GetParameter(1);
  hist026tau2  = fit2exp -> GetParameter(2);
  hist026tau1Err  = fit2exp -> GetParError(1);
  hist026tau2Err  = fit2exp -> GetParError(2);

  cout << "Err for hist 026 " << hist026tau2Err << endl;
  gr5 -> Draw("ap");
  gr55 -> Draw("p");
  ...
  gr66 -> Fit(fit1exp,"0");
  storagehist029A_1expfit =fit1exp->GetParameter(1);
  storageErrhist029A_1expfit =fit2exp->GetParError(1);

  gr66 -> Fit(fit2exp, "1" );
  hist029Atau1  = fit2exp -> GetParameter(1);
  hist029Atau2  = fit2exp -> GetParameter(2);
  hist029Atau1Err  = fit2exp -> GetParError(1);
  hist029Atau2Err  = fit2exp -> GetParError(2);
  ...
  */
  ...
  gr77 -> Fit(fit1exp,"0");
  storagehist031_1expfit =fit1exp->GetParameter(1);
  storageErrhist031_1expfit =fit2exp->GetParError(1);

  gr77 -> Fit(fit2exp , "R");
  hist031tau1  = fit2exp -> GetParameter(1);
  hist031tau2  = fit2exp -> GetParameter(2);
  hist031tau1Err  = fit2exp -> GetParError(1);
  hist031tau2Err  = fit2exp -> GetParError(2);
  ...
  gr88 -> Fit(fit1exp,"0");
  storagehist002_1expfit =fit1exp->GetParameter(1);
  storageErrhist002_1expfit =fit2exp->GetParError(1);

  gr88 -> Fit(fit2exp, "1");
  hist002tau1  = fit2exp -> GetParameter(1);
  hist002tau2  = fit2exp -> GetParameter(2);
  hist002tau1Err  = fit2exp -> GetParError(1);
  hist002tau2Err  = fit2exp -> GetParError(2);
  ...
  gr99 -> Fit(fit1exp,"0");
  storagehist006_1expfit =fit1exp->GetParameter(1);
  storageErrhist006_1expfit =fit2exp->GetParError(1);

  gr99 -> Fit(fit2exp, "1");
  hist006tau1  = fit2exp -> GetParameter(1);
  hist006tau2  = fit2exp -> GetParameter(2);
  hist006tau1Err  = fit2exp -> GetParError(1);
  hist006tau2Err  = fit2exp -> GetParError(2);
  ...
  storagehist021_1expfit =fit1exp->GetParameter(1);
  storageErrhist021_1expfit =fit2exp->GetParError(1);

  gr1010 -> Fit(fit2exp, "1");
  hist021tau1  = fit2exp -> GetParameter(1);
  hist021tau2  = fit2exp -> GetParameter(2);
  hist021tau1Err  = fit2exp -> GetParError(1);
  hist021tau2Err  = fit2exp -> GetParError(2);
  ...
  */
  ...
  double storageHist_1expfit[10] = { storagehist003_1expfit, storagehist013_1expfit, storagehist023_1expfit, storagehist025_1expfit, storagehist026_1expfit, storagehist029A_1expfit,  storagehist031_1expfit,  storagehist006_1expfit ,  storagehist021_1expfit};
  
  // ERROR ASSOCIATED WITH THE STRAGE TIME FROM ONE EXPONENTIAL FIT FROM THE HISTOGRAM COUNTS
  double storageErrHist_1expfit[10] = { storageErrhist003_1expfit, storageErrhist013_1expfit, storageErrhist023_1expfit, storageErrhist025_1expfit, storageErrhist026_1expfit, storageErrhist029A_1expfit ,storageErrhist031_1expfit ,   storageErrhist006_1expfit,  storageErrhist021_1expfit};
  ...
  // TAU1 FROM THE TWO EXPONENTIAL FIT FUNCTION
  double tau1hist[10] = { hist003tau1,  hist013tau1, hist023tau1, hist025tau1, hist026tau1, hist029Atau1,  hist031tau1,  hist006tau1, hist021tau1};
  
  // ERROR ASSOCIATED WITH TAU1
  double tau1Errhist[10] = { hist003tau1Err, hist013tau1Err, hist023tau1Err, hist025tau1Err, hist026tau1Err, hist029Atau1Err, hist031tau1Err, hist006tau1Err, hist021tau1Err};

  // TAU2 FROM THE TWO EXPONENTIAL FUNCTION
  double tau2hist[10] = { hist003tau2, hist013tau2, hist023tau2, hist025tau2, hist026tau2, hist029Atau2,  hist031tau2,  hist006tau2, hist021tau2};
  
  // ERROR ASSOCIATED WITH TAU2
  double tau2Errhist[10] = {  hist003tau2Err, hist013tau2Err, hist023tau2Err, hist025tau2Err, hist026tau2Err, hist029Atau2Err, hist031tau2Err,  hist006tau2Err, hist021tau2Err};
  ...
  TGraphErrors *grhist1exp = new TGraphErrors(9, experiment, storageHist_1expfit, 0 ,storageErrHist_1expfit);
  grhist1exp -> SetTitle("Storage Time vs The Experiment Number, One Exponential Fit");
  grhist1exp -> GetXaxis()-> SetTitle("Experiment number" );
  grhist1exp -> GetYaxis()-> SetTitle("Storage Time (s)");
  grhist1exp -> SetMarkerStyle(7);
  grhist1exp -> SetMarkerColor(1); 

  TLegend *leg2 = new TLegend (0.7,0.7, 0.9, 0.9);
  leg2 -> SetHeader("");
  leg2 -> AddEntry(grfit1exp, "Without Background", "p"); 
  leg2 -> AddEntry(grhist1exp, "With Background", "p");
  ...
  TGraphErrors *grtau1hist = new TGraphErrors(9, experiment, tau1hist, 0 ,tau1Errhist);
  grtau1hist -> SetTitle("Storage Time vs The Experiment Number ,  Two Exponential Fit");
  grtau1hist -> GetXaxis()-> SetTitle("Experiment number" );
  grtau1hist -> GetYaxis()-> SetTitle("Tau1 (s)");
  grtau1hist -> SetMarkerStyle(25);
  grtau1hist -> SetMarkerColor(1); 

  TLegend *leg3 = new TLegend (0.7,0.7, 0.9, 0.9);
  leg3 -> SetHeader("");
  leg3 -> AddEntry(grtau1fit, "Without Background", "p"); 
  leg3 -> AddEntry(grtau1hist, "With Background", "p");
  ...
  TGraphErrors *grtau2hist = new TGraphErrors(9, experiment, tau2hist, 0 ,tau2Errhist);
  grtau2hist -> SetTitle("Tau2 vs The Experiment Number,  Two Exponential Fit ");
  grtau2hist -> GetXaxis()-> SetTitle("Experiment number" );
  grtau2hist -> GetYaxis()-> SetTitle("Tau2 (s)");
  grtau2hist -> SetMarkerStyle(25);
  grtau2hist -> SetMarkerColor(1); 

  TLegend *leg4 = new TLegend (0.7,0.7, 0.9, 0.9);
  leg4 -> SetHeader("");
  leg4 -> AddEntry(grtau2fit, "Without Background", "p"); 
  leg4 -> AddEntry(grtau2hist, "With Background", "p");
