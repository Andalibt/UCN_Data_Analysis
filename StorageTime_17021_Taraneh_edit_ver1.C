...
void StorageTime_17021_Taraneh_edit_ver1(){
  gStyle->SetOptFit(1111);
  // READ THE TREE
  
  TFile *fin = new TFile("outputTree_StorageTime_17021.root","READ");
  if ( fin->IsOpen() ){
  ...
  text -> SetTextAngle(0);
  text -> DrawText(0.4, 0.8, "Exp #: TCN17021");
  ...
  c6 -> SetLogy();
  TGraphErrors *gr = new TGraphErrors(9, delayTimeArray, UCNIntegralArray, 0 , UCNIntegralErrArray);
 ...
 TGraphErrors *gr2 = new TGraphErrors(9, delayTimeArray, HistIntegralArray, 0 , 0);
