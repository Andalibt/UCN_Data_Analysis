...
void StorageTime_17029A_Taraneh_edit_ver1(){
  gStyle->SetOptFit(1111);
  // READ THE TREE
  
  TFile *fin = new TFile("outputTree_StorageTime_17029A.root","READ");
  if ( fin->IsOpen() ){
  ...
  text -> SetTextAngle(0);
  text -> DrawText(0.4, 0.8, "Exp #: TCN17029A");
  ...
  gr -> GetYaxis() -> SetRangeUser(1,100000);
  gr -> SetMarkerStyle(7);
  gr -> Fit(fit, "0");
