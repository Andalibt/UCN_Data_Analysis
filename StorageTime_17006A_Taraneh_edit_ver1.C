...
void StorageTime_17006A_Taraneh_edit_ver1(){
  gStyle->SetOptFit(1111);
  // READ THE TREE
  
  TFile *fin = new TFile("outputTree_StorageTime_17006A.root","READ");
  if ( fin->IsOpen() ){
  ...
  TH2* UCN = new TH2F("UCN", "UCN vs run#", 1000, 600, 615 , 1000,  0., 200000);
  
  // HISTOGRAM TO SHOW THE AVERAGE ISOPURE TEMPERATURE VS THE RUN NUMBER
  TH2* runTemp = new TH2F("UCN", "Temperature vs run#", 1000, 600, 615,1000, 0.83, 1.1);
