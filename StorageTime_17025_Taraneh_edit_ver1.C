...
void StorageTime_17025_Taraneh_edit_ver1(){
  gStyle->SetOptFit(1111);
  // READ THE TREE
  
  TFile *fin = new TFile("outputTree_StorageTime_17025.root","READ");
  if ( fin->IsOpen() ){
  ...
  text -> SetTextAngle(0);
  text -> DrawText(0.4, 0.8, "Exp #: TCN17025");
  ...
  TGraphErrors *gr = new TGraphErrors(19, delayTimeArray, UCNIntegralArray, 0 , UCNIntegralErrArray);
