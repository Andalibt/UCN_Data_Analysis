...
void StorageTime_17009A_Taraneh_edit_ver2(){
  ...
  for (midasrun = 708 ; midasrun <709; midasrun++){
    ...
    TCanvas *canvas[1000];
    canvas[file_counter] = new TCanvas(Form("c%d",midasrun), " ", 1200, 800);
    
    //cmidasrun[file_counter] = new TCanvas("cmidasrun" , "cmidasrun" , 1200, 800);
    canvas[file_counter] ->  Divide(2,2);
    //cmidasrun -> cd(1);


    TPad *p1 = canvas[file_counter]-> cd(1);
    p1->SetLogy(); 
    ...
    grmidasrun_delaycounts -> SetMarkerStyle(7);
    ...
    grmidasrun_delayhist -> SetMarkerStyle(7);
    ...
    grmidasrun_tempIrradcounts -> SetMarkerStyle(7);
    ...
    grmidasrun_tempValveOpencounts -> SetMarkerStyle(7);
    ...
    grmidasrun_delaytempIrrad -> SetMarkerStyle(7);
    ...
    grmidasrun_delaytempValveOpen -> SetMarkerStyle(7);
    ...
    TPad *p2 = canvas[file_counter]->cd(2);
    p2->SetLogy(); 
    ...
    grmidasrun_curcounts -> SetMarkerStyle(7);
    ...
    grmidasrun_curhist -> SetMarkerStyle(7);
    
    grmidasrun_curcounts -> Draw("Ap");
    grmidasrun_curhist -> Draw("p");
    leg2 -> Draw();
    canvas[file_counter] -> Update();
    
    //TCanvas *cmidasrun_cycleNum = new TCanvas("cmidasrun_cycleNum" , "cmidasrun_cycleNum" , 1200, 800);
    TCanvas *canvas_cylceNum[1000];
    canvas_cycleNum[file_counter] = new TCanvas(Form("c%d_cycleNum",midasrun));
    
    canvas_cycleNum[file_counter] -> Divide(2,2);

     TPad *p5 = canvas_cycleNum[file_counter]->cd(1);
     p5->SetLogy(); 
    ...
    grmidasrun_cyclecounts -> SetMarkerStyle(7);
    ...
    grmidasrun_cyclehist -> SetMarkerStyle(7);
    ...
    canvas_cycleNum[file_counter] -> cd(2);
    ...
    grmidasrun_cycledelay -> SetMarkerStyle(7);
    
    grmidasrun_cycledelay -> Draw("Ap");
    
    
    canvas_cycleNum[file_counter] -> cd(3);
    ...
    grmidasrun_cycletempIrrad -> SetMarkerStyle(7);
    ...
    grmidasrun_cycletempValveOpen -> SetMarkerStyle(7);
    ...
    canvas_cycleNum[file_counter] -> cd(4);
    ...
    grmidasrun_cyclecur -> SetMarkerStyle(7);
    grmidasrun_cyclecur -> Draw("Ap");
    canvas_cycleNum[file_counter] -> Update();
    
    //TCanvas *cmidasrun_cycleNumFit = new TCanvas("cmidasrun_cycleNumFit" , "cmidasrun_cycleNumFit" , 1200, 800);
    TCanvas *canvas_cycleNumFit[1000];
    canvas_cycleNumFit[file_counter] = new TCanvas(Form("c%d",midasrun), " ", 1200, 800);
    
    canvas_cycleNumFit[file_counter] -> Divide(2,2);
    
    canvas_cycleNumFit[file_counter] -> cd(1);
    ...
    grmidasrun_cyclefall -> SetMarkerStyle(7);
    grmidasrun_cyclefall -> Draw("Ap");
    
    
    canvas_cycleNumFit[file_counter] -> cd(2);
    ...
    grmidasrun_cyclebaseline -> SetMarkerStyle(7);
    grmidasrun_cyclebaseline -> Draw("Ap");
    
    canvas_cycleNumFit[file_counter] -> cd(3);
    ...
    grmidasrun_cyclebaselineirrad -> SetMarkerStyle(7);
    grmidasrun_cyclebaselineirrad -> Draw("Ap");
    
    canvas_cycleNumFit[file_counter] -> cd(4);
    ...
    grmidasrun_cyclerise -> SetMarkerStyle(7);
