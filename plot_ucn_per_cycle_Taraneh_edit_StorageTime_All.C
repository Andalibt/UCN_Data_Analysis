...
void plot_ucn_per_cycle_Taraneh_edit_StorageTime_All(){  
  // Get the file
  char *filename[200];
  ...
  TFile hfile ("outputTree_StorageTime_All.root", "RECREATE");
 ...
 TH2F *psd_vs_ql_withcuts[16];
  ...
  Int_t StorageTimeFiles[173] =  {532, 533, 534 ,535, 536, 537, 538, 540, 541, 542, 543, 544, 545,546, 562, 563, 564, 565, 566, 567, 568, 569, 570, 571, 572, 573, 574, 575, 576, 577, 578, 579, 580, 581, 595, 596, 597, 598, 599, 600, 601, 602, 605, 606, 607, 608, 609, 610, 611, 612, 613, 662, 663, 664, 665, 666, 667, 668, 669, 670, 671, 672, 673, 675, 676, 677, 678, 679, 680, 681, 682, 683, 684, 685, 686, 687, 688, 689, 690, 692, 693, 695, 696, 697, 698, 699, 700, 701, 702, 703, 704, 705, 706, 707, 708, 709, 710, 711, 712, 713, 714 , 715, 716, 717, 718,719, 720, 721, 722, 723, 724, 725, 726, 727, 728, 729, 730, 731, 732, 733, 734, 735, 736, 737, 738, 739, 740, 741, 742, 743, 744, 745 , 746, 747, 748, 749, 750,751, 752, 753, 754, 755, 756, 757, 758, 759, 760, 761, 762, 763, 764, 777, 780, 781, 782, 783, 784, 785, 786, 791, 803, 813, 819, 821, 827, 832, 834};
  ...
  for ( midasrun =524; midasrun <838; midasrun++){
	...
	numcycle=j+1;
      ...
      double b1_max[max] = 0;
      double b1_min[max] = 100;
      double prdcur_max[max] = 0;
      double prdcur_min[max] = 100;
      double tnim_max[max] = 0;
      double tnim_min[max] = 1000;
      double targettemp1_max[max] = 0;
      double targettemp1_min[max] = 100;
      double targettemp2_max[max] = 0;
      double targettemp2_min[max] = 100;
      double wtemp1_max[max] = 0;
      double wtemp1_min[max] = 1000;
      double wtemp2_max[max] = 0;
      double wtemp2_min[max] = 1000;
      double col2up_max[max] = 0;
      double col2up_min[max] = 100;
      double col2down_max[max] = 0;
      double col2down_min[max] = 100;
      double col2right_max[max] = 0;
      double col2right_min[max] = 100;
      double col2left_max[max] = 0;
      double col2left_min[max] = 100;
      int counter_3=1 , counter_2=1, counter_1 = 1, counter_4 = 1;

      double avets12_temperature_irrad[max] = 0;
      double avets12_temperature_valveOpen[max] = 0; 
      double fm1_ave[max] = 0;
      double maxts12_temperature_irrad[max] = 0;
      double mints12_temperature_irrad[max] = 100;
      double maxts12_temperature_valveOpen[max] = 0 ;
      double mints12_temperature_valveOpen[max] = 100;
      double fm1_max[max] = 0;
      double fm1_min[max] = 1000;
	...
	Integral[i] = Li6_Fit_Func -> Integral(cyclevalveopen[i] , cyclevalveclose[i]);
