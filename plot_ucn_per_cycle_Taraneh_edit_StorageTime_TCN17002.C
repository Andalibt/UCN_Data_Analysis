...
//             UCN 2017 analysis
//********************************************************
// THIS FILE IS TO CREATE A ROOT FILE FOR EXPERIMENT
// TCN17002 WHICH IS A STORAGE LIFETIME MEASRUEMENT.
//*******************************************************
...
void plot_ucn_per_cycle_Taraneh_edit_StorageTime_TCN17002(){  
  // Get the file
  char *filename[200];
  ...
  TFile hfile ("outputTree_StorageTime_17002.root", "RECREATE");
 ...
 TH2F *psd_vs_ql_withcuts[16];
  ...
  Int_t StorageTimeFiles[173] = {532, 533, 534 ,535, 536, 537, 538, 540};
  ...
  for ( midasrun =524; midasrun <838; midasrun++){
	...
	cout << "CYCLE " << i << " " << prdcur_ave[i] << endl;
	if (prdcur_ave[i] >  0.)
